...
export const createOrangeAviSvi2Schema = z.object({
...
export type CreateOrangeAviSvi2Dto = z.infer<typeof createOrangeAviSvi2Schema>;

// Schéma de mise à jour : tous les champs deviennent optionnels.
export const updateOrangeAviSvi2Schema = createOrangeAviSvi2Schema
...
export type UpdateOrangeAviSvi2Dto = z.infer<typeof updateOrangeAviSvi2Schema>;
